...
public class Rulesaec2d435c6424d63826536bec33ffe68_rule_Delay_32Compensation_32for_32Silver_32Loyalty {
                                      ...
                                      .build(D.pattern(var_$issue).expr("GENERATED_C9469C6F9A41126D9BD16BD3CE006421",
                                                                        ...
                                                                        D.reactOn("issueType")).expr("GENERATED_4B448709C139964FF60AAF6153D427AB",
                                                                                                     ...
                                                                                                     D.reactOn("issueDuration")).expr("GENERATED_65A9D3A716479C5194F3A4A81D11552A",
                                                                                                                                      org.acme.P71.LambdaPredicate7101ECC5B130C11210B1C7C0D1F0A002.INSTANCE,
                                                                                                                                      D.alphaIndexedBy(java.lang.String.class,
                                                                                                                                                       org.drools.model.Index.ConstraintType.EQUAL,
                                             ...
                                             D.on(var_$issue).execute(org.acme.P58.LambdaConsequence58A1DC65CE51FA52F2DA85A96C8F81D0.INSTANCE));
        return rule;
    }
}
