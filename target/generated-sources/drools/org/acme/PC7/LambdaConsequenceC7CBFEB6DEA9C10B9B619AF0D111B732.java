...
public enum LambdaConsequenceC7CBFEB6DEA9C10B9B619AF0D111B732 implements org.drools.model.functions.Block2<org.drools.model.Drools, org.acme.FlightIssue>, org.drools.model.functions.HashedExpression {

    INSTANCE;

    public static final String EXPRESSION_HASH = "4F077BFD6E1B1FEDA80A9871039C6BC3";
    ...
    public void execute(org.drools.model.Drools drools, org.acme.FlightIssue $1) throws java.lang.Exception {
        {
            {
                ($1).setCustomerCompensation(50.0);
            }
            {
                ($1).setApproved(true);
            }
