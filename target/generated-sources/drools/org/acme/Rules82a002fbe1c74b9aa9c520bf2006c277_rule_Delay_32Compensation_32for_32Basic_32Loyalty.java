...
public class Rules82a002fbe1c74b9aa9c520bf2006c277_rule_Delay_32Compensation_32for_32Basic_32Loyalty {
                                      ...
                                      .build(D.pattern(var_$issue).expr("GENERATED_C9469C6F9A41126D9BD16BD3CE006421",
                                                                        ...
                                                                        D.reactOn("issueType")).expr("GENERATED_4B448709C139964FF60AAF6153D427AB",
                                                                                                     ...
                                                                                                     D.reactOn("issueDuration")).expr("GENERATED_8B14C44E0A698D42023A187449B51D63",
                                                                                                                                      org.acme.P40.LambdaPredicate4090327D618FECDE1EEC2AC7BBB11D75.INSTANCE,
                                                                                                                                      D.alphaIndexedBy(java.lang.String.class,
                                                                                                                                                       org.drools.model.Index.ConstraintType.EQUAL,
                                             ...
                                             D.on(var_$issue).execute(org.acme.P29.LambdaConsequence29A684B966028FC8249922A3BBF40861.INSTANCE));
        return rule;
    }
}
